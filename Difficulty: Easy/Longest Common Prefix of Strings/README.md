...
<pre><span style="font-size: 18px;"><strong>Examples</strong></span><br><br><span style="font-size: 18px;"><strong>Input: n</strong> = 4, arr[] = [geeksforgeeks, geeks, geek, geezer]
<strong>Output:</strong> gee
<strong>Explanation</strong>: "gee" is the longest common prefix in all the given strings.</span>
<br><br><span style="font-size: 18px;"><strong>Input</strong>: n = 2, arr[] = [hello, world]
